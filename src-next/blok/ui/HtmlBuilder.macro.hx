...
class HtmlBuilder {
    ...
    for (tag in tags) switch tag.kind {
      case TagNormal:
        ...
        fields = fields.concat((macro class {
          ...
          public static inline function $name(
            props:blok.ui.Html.HtmlChildrenProps<$type & blok.ui.HtmlEvents>
          ):VNode<Node> {
            return VNative(
              NodeType.get($v{name}),
              props.attrs,
      ...
      default:
        ...
        fields = fields.concat((macro class {
          ...
          public static inline function $name(
            props:blok.ui.Html.HtmlBaseProps<$type & blok.ui.HtmlEvents>
          ):VNode<Node> {
            return VNative(
              NodeType.get($v{name}),
              props.attrs,
  ...
  static function getTags():Array<TagInfo> {
    ...
    var t = Context.getType('blok.ui.HtmlTags');
    var groups = switch t {
